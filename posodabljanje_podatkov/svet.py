...
def posodobi_svet(svet_iata = ["DEN", "CAN", "HKG", "CTU", "SZX", "CKG", "MIA", "PHX", "SEA", "LAS"]):
    """funkcija prejme iata id letalisc in posodobi podatki_svet.json z leti iz teh letalisc
